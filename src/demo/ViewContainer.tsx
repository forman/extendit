...
function ViewContainer() {
    ...
    return (
        <div style={{width: "100%"}}>
            <h1>Current View: {selectedView ? selectedView.title : "No view selected"}</h1>
            <p>Shows a selected view (UI component) of the <code>views</code> contribution point:</p>
            <div>
                {selectedView && <ViewComponentContainer key={selectedViewId} view={selectedView}/>}
            </div>
        </div>
    );
}
