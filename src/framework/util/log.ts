...
export class LogLevel {
     ...
     */
    static readonly DEBUG= new LogLevel("DEBUG", 100, "color:green;font-weight:bold;", console.debug);
    /**
     * Log at information level. Its value is 200.
     */
    static readonly INFO= new LogLevel("INFO", 200, "color:blue;font-weight:bold;", console.info);
    /**
     * Log at warning level. Its value is 300.
     */
    static readonly WARN= new LogLevel("WARN", 300, "color:orange;font-weight:bold;", console.warn);
    /**
     * Log at error level. Its value is 400.
     */
    static readonly ERROR= new LogLevel("ERROR", 400, "color:red;font-weight:bold;", console.error);
