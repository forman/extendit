 ...
 */
export const deactivateExtension = async (extensionId: string): Promise<Extension> => {
    ...
    try {
        if (ctx.module
            && ctx.module.deactivate instanceof Function) {
        ...
        LOG.error(`An error occurred during deactivation of extension '${extensionId}':`, error);
